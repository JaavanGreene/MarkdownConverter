...
export class OutputConverter {
    ...
    */
    static convertParagraphs(input) {
        ...
        //it is possible that lines start with a link and only contain said link. This will be cleaned later
    ...
    /*
        Header conversion checks that you have anywhere  from 1 to 6 #'s with at least one space followed by the header text
    */
